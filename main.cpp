...
// camera
float camera_z = 0.0f;
Camera camera(glm::vec3(-18.0f, 1.5f, 1.0f));
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        transM = glm::translate(identityMatrix, glm::vec3(0.5, 10.5, 0.5f));
        ...
        translateMatrix = glm::translate(identityMatrix, glm::vec3(-4.2f, -2.8f, -1.55f));
        rotateYMatrix = glm::rotate(identityMatrix, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
        ...
        translateMatrix = glm::translate(identityMatrix, glm::vec3(-4.2f, -2.8f, -0.5f));
        rotateYMatrix = glm::rotate(identityMatrix, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
        scaleMatrix = glm::scale(identityMatrix, glm::vec3(0.8f,0.8f, 2.0f));
        ...
        container4.drawCubeWithTexture(lightingShaderWithTexture, conTruck);
